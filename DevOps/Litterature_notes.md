...
* DevOps was inspired by Agile movement (2001)
* Toyotas Production system = Value Stream mapping, kanban boards, total productive maintenance
* Lean Movement = predictor of quality, customer satisfaction and employee happiness.
* Small batch sizes, continous deployment to customers,
* Improvement kata = work routines, daily structure, habits. Daily practices = improves outcome.
* Flow, Feedback, Continual Learning and Experimentation.

## Myths

* DevOps is Only for Startups = Google, Amazon, Netflix are "unicorns"
* DevOps replaces Agile = Agile Journey (2001) Agile is enabler of DevOps.
* DevOps Means eliminating IT Operations = IT Operations may change, but won't be killed.
* Devops is just Automation = DevOps is Culture.  
*"DevOps isn't about automation, just as astronomy isn't about telescopes."*  
* DevOps is Only for Open Source Software = Even though transparency is a DevOps principle. Successes have been achieved with .NET, COBOL, assembly code also SAP and embedded systems like HP LaserJet.
